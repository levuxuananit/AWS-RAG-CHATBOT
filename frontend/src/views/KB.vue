    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-4" style="max-width: 350px;">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <label style="font-weight:lighter;color:grey">What percentage of Amazon’s annual revenue was recognized in Q4 of 2019?</label>
            <br />
            <label style="font-weight:lighter;color:grey"> What is one major risk Amazon identifies related to inventory?</label>
            <br />
            <label style="font-weight:lighter;color:grey">How much owned square footage did Amazon have allocated to AWS as of December 31, 2019?</label>
            <br />
            <label style="font-weight:lighter;color:grey">What was the total number of shares of common stock outstanding as of January 22, 2020?</label>
            <br />
            <label style="font-weight:lighter;color:grey" >How many shareholders of record did Amazon have as of January 22, 2020?</label>
            <br />
            <label style="font-weight:lighter; color:grey" >How many leased square feet did Amazon report in North America for fulfillment, data centers, and other uses?</label>
          </div>
        </div>
      </div>
    </div>
