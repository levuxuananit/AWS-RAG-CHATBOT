      ...
      <div class="col-lg-6 mb-4" style="max-width: 350px;">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <br />
            <label style="font-weight:lighter;color:grey">All cats are animals. Some animals can swim. Do all cats know how to swim? Explain.</label>
            <br />
            <label style="font-weight:lighter;color:grey" >If each person drinks an average of 2.5 glasses of water per hour, how many liters of water are needed for 30 people over 4 hours?</label>
            <br />
            <label style="font-weight:lighter; color:grey" >Tell me a story around a cat and mouse.</label>
          </div>
        </div>
      </div>
    </div>
